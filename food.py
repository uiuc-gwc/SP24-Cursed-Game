...
class Food(pygame.sprite.Sprite):
    def __init__(self, food_type, screen_width, screen_height):
        ...
        # Some starter stuff:
        # TODO: Change the starting position of the food object.
        # https://docs.python.org/3/library/random.html
        # has some resources on how to get a random number. 
        starting_position = (150, 500)
    ...
    def update(self):
        # TODO: ove the food down. 
        # You can change the position of the food by changing self.rect.x and self.rect.y

        # TODO: If the food is off the screen, hide it. see hide() below. 
